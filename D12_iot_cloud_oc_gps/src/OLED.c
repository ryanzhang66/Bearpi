...
u32 my_i2c_write (WifiIotI2cIdx id, u16 device_addr, u32 send_len)
{
    ...
    status = I2cWrite(id, deviceAddr, &es8311_i2c_data);
    if (status != 0) {
...
u32 my_i2c_write(WIFI_IOT_I2C_IDX, u16 device_addr, u32 send_len)
{
    u32 status;
...
void my_oled_demo(void)
{
    ...
    //IoTGpioSetFunc(13,IOT_IO_FUNC_GPIO_13_I2C0_SDA);
	IoTGpioSetFunc(13,IOT_GPIO_FUNC_GPIO_13_I2C0_SDA);
    //IoTGpioSetFunc(14,IOT_IO_FUNC_GPIO_14_I2C0_SCL);
    ...
    OLED_ShowString(8,16,"hello world_lele",16);
